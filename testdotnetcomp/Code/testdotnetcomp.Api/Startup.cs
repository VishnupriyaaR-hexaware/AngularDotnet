using testdotnetcomp.Api.Installer;
using testdotnetcomp.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using testdotnetcomp.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace testdotnetcomp.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "testdotnetcomp V1");
        });
